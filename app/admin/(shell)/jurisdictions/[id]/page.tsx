  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-5">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-sm font-semibold text-gray-900">Legal Rates</h3>
            <p className="mt-0.5 text-xs text-gray-500">
              Manage annual interest rates and other compliance rates for this jurisdiction.
            </p>
          </div>
          <div className="flex gap-2 shrink-0">
            <Link
              href={`/admin/jurisdictions/${jurisdiction.id}/rates`}
              className="rounded-lg border border-gray-300 px-3 py-1.5 text-sm font-semibold text-gray-600 hover:bg-gray-50 transition"
            >
              View Rates
            </Link>
            {canWrite && (
              <Link
                href={`/admin/jurisdictions/${jurisdiction.id}/rates/new`}
                className="inline-flex items-center gap-1 rounded-lg bg-green-600 px-3 py-1.5 text-sm font-semibold text-white hover:bg-green-700 transition"
              >
                <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
