...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const allowed = ['status', 'title', 'description', 'monthly_rent', 'address', 'city', 'state', 'zip', 'bedrooms', 'bathrooms', 'living_area_sqft', 'available_date', 'property_type', 'listing_source', 'agent_name', 'office_name', 'license_number'];
