...
export async function POST(
  ...
  try {
    ...
    await logError({ source: 'Listings › :id › Applications › :id › Message', message: _msg, details: _stack, endpoint: 'POST /api/listings/[id]/applications/[appId]/message', http_status: 500 });
