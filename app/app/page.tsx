...
export const metadata: Metadata = {
  title: 'Get the RentalDom App',
  description:
    'Search rentals, chat with landlords, and apply in minutes. RentalDom is coming soon to the App Store and Google Play.',
};
  ...
  return (
    <section className="mx-auto flex max-w-3xl flex-col items-center px-4 py-24 text-center sm:px-6">
      ...
      <h1 className="mt-8 text-4xl font-extrabold text-gray-900">
        The RentalDom app is almost here
      </h1>
      <p className="mt-4 max-w-xl text-lg text-gray-600">
        We&apos;re putting the finishing touches on the RentalDom app for iPhone and
