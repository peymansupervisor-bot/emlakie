...
export const metadata: Metadata = {
  ...
  description: "Get a free rent estimate for your property. See what similar homes rent for in your area — powered by real listings data. Perfect for landlords.",
