    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div className="mt-10 space-y-10 leading-relaxed text-gray-700">
        ...
        <section id="section-10">
          <h2 className="text-xl font-bold text-gray-900">10. Third-Party Services</h2>
          <p className="mt-2">
        ...
        <section id="section-11">
          <h2 className="text-xl font-bold text-gray-900">11. Disclaimers</h2>
          <p className="mt-2">
        ...
        <section id="section-14">
          <h2 className="text-xl font-bold text-gray-900">14. Arbitration and Class Action Waiver</h2>
          <p className="mt-2">
        ...
        <section id="section-15">
          <h2 className="text-xl font-bold text-gray-900">15. Governing Law</h2>
          <p className="mt-2">
        ...
        <section id="section-17">
          <h2 className="text-xl font-bold text-gray-900">17. Changes to These Terms</h2>
          <p className="mt-2">
        ...
        <section id="section-18">
          <h2 className="text-xl font-bold text-gray-900">18. Contact Information</h2>
