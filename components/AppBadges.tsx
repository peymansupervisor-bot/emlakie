const badgeClass =
  'flex items-center justify-center gap-3 rounded-xl bg-gray-900 px-5 py-3 text-white transition hover:bg-gray-800 sm:justify-start';

export default function AppBadges() {
  return (
    <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-4">
      <a href="/app" className={badgeClass}>
