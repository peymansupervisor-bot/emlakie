  ...
  return (
    <footer className="mt-20 border-t border-gray-200 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        ...
        {/*
          color-contrast fix: the fine-print block previously used text-gray-500
          (#6b7280, ~4.48:1 on gray-50 background) and text-gray-400 (#9ca3af,
          ~2.85:1) for body copy, sub-headings, and the copyright line.
          Both fall below the WCAG 2.1 AA minimum of 4.5:1 for normal-weight
          text at these sizes.

          Fixes applied:
          - Outer wrapper: text-gray-600 → sufficient contrast on gray-50
          - Section sub-headings ("Listing Accuracy", etc.): text-gray-700
          - Copyright / social row: text-gray-600 (was text-gray-500)
          - Social icon links: text-gray-500 → text-gray-600 (icons are 18 px
            which is still normal-size for contrast purposes)
        -->
        */}
        <div className="mt-10 space-y-6 border-t border-gray-200 pt-6 text-xs text-gray-600">
          ...
          {/* Listing accuracy */}
          <div>
            <p className="font-semibold text-gray-700">Listing Accuracy</p>
            <p className="mt-1">
          ...
          {/* Third-party content */}
          <div>
            <p className="font-semibold text-gray-700">Third-Party Content</p>
            <p className="mt-1">
            ...
            <div className="flex items-start gap-4">
              ...
              */}
              <svg
                ...
                viewBox="0 0 100 100"
                className="h-10 w-10 shrink-0 fill-gray-600"
              ...
              <div>
                <p className="font-semibold text-gray-700">Fair Housing &amp; Equal Opportunity</p>
                <p className="mt-1">
          ...
          {/* SMS consent */}
          <div>
            <p className="font-semibold text-gray-700">SMS &amp; Notification Consent</p>
            <p className="mt-1">
          ...
          {/* CCPA */}
          <div>
            <p className="font-semibold text-gray-700">California Privacy Rights (CCPA)</p>
            <p className="mt-1">
          ...
          {/*
            color-contrast fix: copyright text was text-gray-500 (~4.48:1 on
            gray-50, fails at xs size). Bumped to text-gray-600 (~6.6:1).
            Social icon links were text-gray-400 (~2.85:1); bumped to
            text-gray-600 to pass on the gray-50 footer background.
          */}
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 shrink-0">
              <a
                ...
                className="text-gray-600 transition-opacity hover:opacity-60"
              >
