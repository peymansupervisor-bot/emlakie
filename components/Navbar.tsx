    ...
    <header className="sticky top-0 z-50 border-b border-gray-200 bg-white/95 backdrop-blur-sm">
      <nav aria-label="Main navigation" className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-1 md:flex">
          ...
          <Link
            href="/landlord"
            className="ml-1 rounded-lg px-3 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-100 hover:text-gray-900"
          >
            Dashboard
          </Link>
        </div>
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <Link
            href="/landlord/login"
            className="animate-glow-pulse rounded-lg bg-brand-600 px-5 py-2 text-sm font-bold text-white transition hover:bg-brand-700"
          >
            List Property Free
          </Link>
        </div>
