...
export default function RentEstimatorCard() {
  return (
    <div className="mt-4 rounded-2xl p-6" style={{ background: 'linear-gradient(135deg, #f97316 0%, #fb923c 50%, #fdba74 100%)' }}>
      <p className="text-xs font-semibold uppercase tracking-widest text-orange-100">Free tool</p>
      ...
      <Link
        href="/rent-estimate"
        className="mt-4 block w-full rounded-xl bg-white py-2.5 text-center text-sm font-bold text-orange-600 transition hover:bg-orange-50"
      >
